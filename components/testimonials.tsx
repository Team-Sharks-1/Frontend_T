...
const testimonials = [
  {
    ...
    content:
      "UrbanConnect's plumber was a lifesaver! My kitchen faucet was leaking like crazy. They came quickly, fixed it efficiently, and even cleaned up the mess. I'm very satisfied!",
    categories: [1, 3, 5],
  },
  {
  ...
  },
  {
    ...
    company: "Rio",
    content:
      "We had a major clog in our sewer line, and UrbanConnect came to the rescue. Their team was professional, knowledgeable, and got the job done quickly. We're so grateful!",
    categories: [1, 2, 5],
  },
  {
    ...
    content:
      "Our home was a mess after a family gathering. UrbanConnect's maids came in and made it sparkle. They were so thorough and professional, and our house felt like a brand new place! ",
    categories: [1, 4],
  },
  {
    ...
    company: "Housewife",
    content:
      "UrbanConnect replaced our old water heater with a new energy-efficient one. They were very helpful explaining the options, and the installation was quick and clean. I highly recommend them!",
    categories: [1, 3, 5],
  },
  {
    ...
    company: "Maffell",
    content:
      "Urban Connect transformed my backyard into a beautiful oasis! The gardeners were professional, knowledgeable, and handled everything from start to finish. I couldn’t be happier with the results – my garden has never looked this good!",
    categories: [1, 3],
  },
  {
    ...
    company: "Binance",
    content:
      "Thanks to Urban Connect, my garden is flourishing! Their team was efficient, friendly, and brought my vision to life. Highly recommend!",
    categories: [1, 2, 5],
  },
  {
    ...
    company: "CA",
    content:
      "Our garden is a joy to look at thanks to UrbanConnect. They're always on time, reliable, and do a great job keeping our flowers blooming and our lawn looking beautiful.",
    categories: [1, 4],
  },
  {
      ...
      <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,theme(colors.slate.400/.25),transparent)1] md:py-20">
        ...
        <div className="mx-auto max-w-3xl pb-12 text-center">
          ...
          <p className="text-lg text-indigo-200/65">
            UrbanConnect delivers seamless, tech-driven solutions that bring top-rated services right to your doorstep, empowering you to create a comfortable and well-maintained home with ease.
          </p>
        </div>
